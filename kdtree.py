...
points = [PointContainer(test_means[i]) for i in range(len(test_means))]
...
# print(get_nearest(kd_tree, [311, 365, 381], dim, dist_sq_dim))
print(get_knn(kd_tree, [311, 365, 381], 3, dim, dist_sq_dim))
"""
